...
def get_data():
    ...
    ds_train = KMNIST(root='./data', train=True, transform=transforms_train, download=True)
    ds_test = KMNIST(root='./data', train=False, transform=transforms_test, download=True)
    ...
    dls = {"train": dl_train_, "valid": dl_test_}
    return dls
